...
function updateTimer() {
  const targetDate = new Date("september 12, 2026 20:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '5492974704970'; // Número para el primer botón
  const phoneNumber2 = '5492974704970'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '5492974704970'; // Número para el primer botón
  const recipientNumber2 = ''; // Número para el segundo botón
